...
<section class="w-11/12 md:w-8/12 mt-16" style="min-height:400px">	
    ...
    <h2 class="text-lg">Update Profile</h2>
	<input type="text" class="w-full bg-black/30 border-b text-indigo-900 border-indigo-900" bind:value="{$userProfil.name}" on:focusout={(e)=>updateUsername(e)}>
    <Toast {toastState}/>
